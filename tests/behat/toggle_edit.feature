@format @format_topcoll @javascript @testnow
Feature: Toggle
  ...
  Scenario: Open a toggle while editing
    When I click on ".the_toggle" "css_element" in the "#toggle-1" "css_element"
    Then "#toggledsection-1" "css_element" should be visible
    And "#toggledsection-2" "css_element" should not be visible

  Scenario: Close a toggle while editing
    When I click on "Open all" "text"
    And I click on ".the_toggle" "css_element" in the "#toggle-1" "css_element"
